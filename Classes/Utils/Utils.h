...
#define IPAD (VirtuPhoneManager.runningOnIpad)
#define ANIMATED ([VirtuPhoneManager.instance lpConfigBoolForKey:@"animations_preference"])
#define LC ([VirtuPhoneManager getLc])
