...
- (void)update {
	...
	if (_messageText && ![VirtuPhoneManager getMessageAppDataForKey:@"localvideo" inMessage:_message]) {
...
- (void)onResend {
	...
	if (linphone_chat_message_get_file_transfer_information(_message) != NULL) {
		NSString *localImage = [VirtuPhoneManager getMessageAppDataForKey:@"localimage" inMessage:_message];
		NSNumber *uploadQuality =[VirtuPhoneManager getMessageAppDataForKey:@"uploadQuality" inMessage:_message];
        NSString *localVideo = [VirtuPhoneManager getMessageAppDataForKey:@"localvideo" inMessage:_message];
        NSString *localFile = [VirtuPhoneManager getMessageAppDataForKey:@"localfile" inMessage:_message];
        ...
        if(localImage){
            ...
            if (img) {
                ...
                PHFetchResult<PHAsset *> *assets = [VirtuPhoneManager getPHAssets:localImage];
...
+ (CGSize)ViewHeightForMessageText:(LinphoneChatMessage *)chat withWidth:(int)width textForImdn:(NSString *)imdnText{
    ...
    if (url == nil && fileContent == NULL) {
        ...
        NSString *localImage = [VirtuPhoneManager getMessageAppDataForKey:@"localimage" inMessage:chat];
        NSString *localFile = [VirtuPhoneManager getMessageAppDataForKey:@"localfile" inMessage:chat];
        NSString *localVideo = [VirtuPhoneManager getMessageAppDataForKey:@"localvideo" inMessage:chat];
        ...
        if(localFile) {
            ...
            if(localImage)
                assets = [VirtuPhoneManager getPHAssets:localImage];
            else
