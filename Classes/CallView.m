...
- (void)viewWillAppear:(BOOL)animated {
	...
	[self hideSpeaker:VirtuPhoneManager.instance.bluetoothAvailable];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    NSString *address = [VirtuPhoneManager.instance lpConfigStringForKey:@"sas_dialog_denied"];
    if (address) {
        ...
        [VirtuPhoneManager.instance lpConfigSetString:nil forKey:@"sas_dialog_denied"];
    }
}
...
- (void)disableVideoDisplay:(BOOL)disabled animated:(BOOL)animation {
	...
	_videoCameraSwitch.hidden = (disabled || !VirtuPhoneManager.instance.frontCamId);
...
- (IBAction)onRoutesBluetoothClick:(id)sender {
	...
	[VirtuPhoneManager.instance setBluetoothEnabled:TRUE];
}

- (IBAction)onRoutesEarpieceClick:(id)sender {
	[self hideRoutes:TRUE animated:TRUE];
	[CallManager.instance setSpeakerEnabled:FALSE];
	[VirtuPhoneManager.instance setBluetoothEnabled:FALSE];
}
...
- (void)updateUnreadMessage:(BOOL)appear {
	int unreadMessage = [VirtuPhoneManager unreadMessageCount];
	if (unreadMessage > 0) {
