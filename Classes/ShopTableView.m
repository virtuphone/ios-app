...
#import "VirtuPhoneUI/UIShopTableCell.h"
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	return VirtuPhoneManager.instance.iapManager.productsAvailable.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	SKProduct *product = VirtuPhoneManager.instance.iapManager.productsAvailable[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	SKProduct *product = VirtuPhoneManager.instance.iapManager.productsAvailable[indexPath.row];
	[VirtuPhoneManager.instance.iapManager purchaseWithID:product.productIdentifier];
}
