...
typedef struct _VirtuPhoneManagerSounds {
    SystemSoundID vibrate;
} VirtuPhoneManagerSounds;

@interface VirtuPhoneManager : NSObject {
@protected
...
@property (readonly) VirtuPhoneManagerSounds sounds;
...
@property(strong, nonatomic) OrderedDictionary *VirtuPhoneManagerAddressBookMap;
