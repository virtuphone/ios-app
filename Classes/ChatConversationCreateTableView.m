...
- (void)viewWillAppear:(BOOL)animated {
	...
	_addresses = [[NSMutableArray alloc] initWithCapacity:VirtuPhoneManager.instance.fastAddressBook.addressBookMap.allKeys.count];
	_phoneOrAddr = [[NSMutableArray alloc] initWithCapacity:VirtuPhoneManager.instance.fastAddressBook.addressBookMap.allKeys.count];
    _addressesCached = [[NSMutableArray alloc] initWithCapacity:VirtuPhoneManager.instance.fastAddressBook.addressBookMap.allKeys.count];
	if(_notFirstTime) {
...
- (void)reloadDataWithFilter:(NSString *)filter {
	...
	while (results) {
		...
		if (addr) {
			...
			contact = [VirtuPhoneManager.instance.fastAddressBook.addressBookMap objectForKey:[FastAddressBook normalizeSipURI:address]];
		}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	Contact *contact = [VirtuPhoneManager.instance.fastAddressBook.addressBookMap objectForKey:[FastAddressBook normalizeSipURI:key]];
