...
- (void)beforeEach {
	[[VirtuPhoneManager instance] lpConfigSetInt:ORTP_WARNING forKey:@"debugenable_preference"];
	[[VirtuPhoneManager instance] lpConfigSetInt:NO forKey:@"animations_preference"];
}
...
- (void)switchToValidAccountIfNeeded {
	...
	if (![self hasValidProxyConfig]) {
		...
		[[VirtuPhoneManager instance] configurePushTokenForProxyConfig:testProxy];
